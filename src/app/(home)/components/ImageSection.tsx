  ...
  return (
    <section className="relative pt-38.25 pb-29">
      <Container className="flex justify-end items-center">
        ...
        />
        <div className="bg-imagesectionbg rounded-xl pl-10.25 pt-15.5 pb-9.25 pr-14 max-w-161 relative">
          <div className="text-zinc-800 font-semibold tracking-[3px] mb-1">
            New Arrival
          </div>
          <div className="text-mainyellow text-5xl font-bold mb-4.25 leading-16.25">
